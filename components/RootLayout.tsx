        ...
        <div className="flex items-center gap-x-8">
          ...
          <button
            ...
            className={clsx(
              ...
              invert ? 'hover:bg-white/10' : 'hover:bg-[#6E0B75]/10'
            )}
            ...
            <Icon
              className={clsx(
                ...
                invert
                  ...
                  : 'fill-[#6E0B75] group-hover:fill-[#6E0B75]'
              )}
            />
          </button>
        </div>
...
function NavigationItem({ href, children }: NavigationItemProps) {
  return (
    <Link
      href={href}
      className="group relative isolate -mx-6 bg-black px-6 py-10 even:mt-px sm:mx-0 sm:px-0 sm:py-16 sm:odd:pr-16 sm:even:mt-0 sm:even:border-l sm:even:border-black sm:even:pl-16"
    >
      {children}
